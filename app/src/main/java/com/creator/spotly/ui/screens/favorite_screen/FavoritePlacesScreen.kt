...
import com.creator.spotly.ui.screens.favorite_screen.component.FavoritePlacesGrid
import com.creator.spotly.ui.screens.favorite_screen.component.FavoriteTopBar

@Composable
fun FavoritePlacesScreen(places: List<Place>, onBackClick: () -> Unit) {
  Scaffold(containerColor = Color.White, topBar = { FavoriteTopBar(onBackClick) }) { paddingValues
    ->
